const _principalAmount = document.getElementsByName("principalAmount");
const _interestRateYear = document.getElementsByName("interestRate");
const _tenureMonth = document.getElementsByName("tenure");
...
function EstimateFixedInterestLoan() {
    const principalAmount = Number(_principalAmount[0].value);
    const interestRateYear = Number(_interestRateYear[0].value);
    const tenureMonth = Number(_tenureMonth[0].value);
